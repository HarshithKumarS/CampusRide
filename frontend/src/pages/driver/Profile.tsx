  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400">View and update your personal information and shift details.</p>
      </div>
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3 text-left text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-green-600 flex items-center">
                  <Shield className="h-3.5 w-3.5 mr-0.5" /> Approved
                </span>
              </div>
            </div>
          </div>
